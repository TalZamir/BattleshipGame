...
public class UserMoveInputTests {
    ...
    public void correctInput() {
        ...
        boolean actual = userMoveInputVerifier.isUserInputOk(new UserMoveInput(1, 5), 5, errorCollector);
    ...
    public void correctInputWithLowerCase() {
        ...
        boolean actual = userMoveInputVerifier.isUserInputOk(new UserMoveInput(5, 5), 5, errorCollector);
    ...
    public void rowIsOutOfRange() {
        ...
        boolean actual = userMoveInputVerifier.isUserInputOk(new UserMoveInput(6, 2), 5, errorCollector);
        assertEquals(false, actual);

        //        actual = userMoveInputVerifier.isUserInputOk(new UserMoveInput(0, "B"), 5, errorCollector);
        actual = userMoveInputVerifier.isUserInputOk(new UserMoveInput(0, 2), 5, errorCollector);
        assertEquals(false, actual);
    }
    ...
    public void colIsOutOfRange() {
        ...
        boolean actual = userMoveInputVerifier.isUserInputOk(new UserMoveInput(2, 6), 5, errorCollector);
    ...
    public void strangeIsOutOfRange() {
        ...
        boolean actual = userMoveInputVerifier.isUserInputOk(new UserMoveInput(9, 8), 5, errorCollector);
        assertEquals(false, actual);

        //        actual = userMoveInputVerifier.isUserInputOk(new UserMoveInput(321, "eew"), 5, errorCollector);
        actual = userMoveInputVerifier.isUserInputOk(new UserMoveInput(321, 5532), 5, errorCollector);
        assertEquals(false, actual);
    }
}
